...
| -------------- | :-------------: | :---------------------------------------------------------------------------------------: |
| contentAuthors |  content/authors  |                     Define where you want to pull your Post data from                     |
| contentPosts   | content/posts |                    Define where you want to pull your Author data from                    |
